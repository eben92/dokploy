...
export const templates: TemplateData[] = [
  ...
  },
  {
    ...
    version: "v2.1.0",
    description:
      "Plausible is an open source, self-hosted web analytics platform that lets you track website traffic and user behavior.",
    logo: "plausible.svg",
    links: {
  ...
  },
  {
    ...
    version: "2.7.6",
    description:
      "Calcom is an open source alternative to Calendly that allows to create scheduling and booking services.",
  ...
  },
  {
    ...
    version: "latest",
    description:
      "MinIO is an open source high-performance, S3 compatible object store.  It is built for large scale AI/ML, data lake and database workloads.",
    ...
    logo: "minio.svg",
    tags: ["S3 compatible", "object store", "backup & recovery"],
